...
const navigation = {
  product: [
    ...
    { name: 'AI Orchestration', href: '/ai-orchestration' },
    ...
    <footer className="bg-white" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-sm leading-6 text-gray-600 mt-2">
                AI-powered platform for website optimization, competitive intelligence, and business growth.
              </p>
            </div>
        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
          <div className="text-xs leading-5 text-gray-500 flex flex-col sm:flex-row justify-between items-center">
